...
4. Select the `.skill` file or `SKILL.md` from the desired skill directory.

For folder-based skills with `references/`, upload the `SKILL.md` file — Claude resolves the references relative to it.
