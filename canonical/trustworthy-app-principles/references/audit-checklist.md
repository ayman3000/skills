...
- [ ] **5. Honesty:** Success and completion claims are backed by verified outcomes. **Red flags:** invented output, fake records hiding empty states, partial failure reported as success, or tests that do not exercise the claim.
